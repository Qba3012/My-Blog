...
$POSTGRES <<EOSQL
    ...
    create table Post (
       id int8 generated by default as identity (start with 6),
    ...
    insert into post_image (
        ...
        values (
            'wood.jpg','WIDTH',0.5,'http://${SERVER}/posts/1/image','/root/my-blog/post1/wood.jpg',1);
    ...
    insert into post_image (
        file_name,image_fit,image_offset,image_url,local_uri,post_id) 
        values (
            'sunny-forest.jpg','WIDTH',0.5,'http://${SERVER}/posts/2/image','/root/my-blog/post2/sunny-forest.jpg',2);
    ...
    insert into post_image (
        file_name,image_fit,image_offset,image_url,local_uri,post_id) 
        values (
            'bridge-sunrise1.jpg','HEIGHT',0.5,'http://${SERVER}/posts/3/image','/root/my-blog/post3/bridge-sunrise1.jpg',3);
    ...
    insert into post_image (
        file_name,image_fit,image_offset,image_url,local_uri,post_id) 
        values (
            'forest-sunset.jpg','WIDTH',0.5,'http://${SERVER}/posts/4/image','/root/my-blog/post4/forest-sunset.jpg',4);
    ...
    insert into post_image (
        file_name,image_fit,image_offset,image_url,local_uri,post_id) 
        values (
            'bridge-sunrise2.jpg','HEIGHT',0.5,'http://${SERVER}/posts/5/image','/root/my-blog/post5/bridge-sunrise2.jpg',5);
